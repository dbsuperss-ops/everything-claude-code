...
**Haiku 4.5** (Sonnet의 90% 성능, 3배 저렴한 비용):

* 빈번하게 호출되는 경량 에이전트
* 페어 프로그래밍 및 단순 코드 생성
* 멀티 에이전트 시스템 내의 작업용 에이전트

**Sonnet 4.6** (코딩에 최적화된 모델):

* 주요 개발 작업 전반
* 멀티 에이전트 워크플로우 오케스트레이션
* 복잡한 코딩 작업

**Opus 4.5** (가장 깊은 추론 능력):
...
확장 추론은 기본적으로 활성화되어 있으며, 내부 추론을 위해 최대 31,999 토큰을 사용합니다.
